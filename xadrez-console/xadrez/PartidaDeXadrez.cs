...
namespace xadrez
{
     class PartidaDeXadrez
    {
        ...
        public Peca ExecutaMoviemnto(Posicao origem, Posicao destino)
        {
        ...
        {
            Peca pecaCapturada = ExecutaMoviemnto(origem, destino);
        ...
        {
            if (!Tab.Peca(origem).MovimentoPossivel(destinho))
            {
